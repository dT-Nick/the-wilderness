...
export function generateSettlementMapState(): MapState {
  ...
  return {
    map: [
      ...
      { type: 'wall', fromCoords: [16, 0], toCoords: [41, 1] },
      { type: 'wall', fromCoords: [42, 0], toCoords: [80, 1] },
      { type: 'hill', fromCoords: [14, 0], toCoords: [16, 1] },
      { type: 'wall', fromCoords: [15, 1], toCoords: [17, 2] },
      { type: 'wall', fromCoords: [80, 2], toCoords: [82, 3] },
      { type: 'wall', fromCoords: [79, 1], toCoords: [81, 2] },
      { type: 'hill', fromCoords: [80, 0], toCoords: [82, 1] },
      { type: 'hill', fromCoords: [81, 1], toCoords: [82, 2] },
      { type: 'forest', fromCoords: [41, 0], toCoords: [42, 1] },
    ],
    discovered: true,
  }
}
