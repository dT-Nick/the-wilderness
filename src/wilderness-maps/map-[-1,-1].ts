...
export function generateMapMinusOneMinusOneState(): MapState {
...
const mapMinusOneMinusOneState: MapState = {
  map: [],
  discovered: false,
}

export function getMapMinusOneMinusOneState() {
  return mapMinusOneMinusOneState
}

export function updateMapMinusOneMinusOneState(
  changes:
    | Partial<typeof mapMinusOneMinusOneState>
    | ((
        state: typeof mapMinusOneMinusOneState
      ) => Partial<typeof mapMinusOneMinusOneState>)
) {
  if (typeof changes === 'function') {
    Object.assign(mapMinusOneMinusOneState, changes(mapMinusOneMinusOneState))
  } else {
    Object.assign(mapMinusOneMinusOneState, changes)
  }
}

export function drawMapMinusOneMinusOne() {
  const { map } = mapMinusOneMinusOneState
...
export function handleMapMinusOneMinusOneInput() {
  ...
  handleMapMinusOneMinusOneExit()
}

export function handleMapMinusOneMinusOneExit() {
